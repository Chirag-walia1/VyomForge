...
import { Mountain, Waves, CloudRain, AlertOctagon, ArrowUpRight } from "lucide-react";
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 my-4">
      {metrics.map((item, idx) => {
        ...
        return (
          <div
            key={idx}
            className={`p-3.5 rounded-xl border ${item.color} backdrop-blur-sm transition-all hover:border-slate-600 flex flex-col justify-between`}
          >
